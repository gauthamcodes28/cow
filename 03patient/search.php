...
<form style="display:none" id="send_id" action="<?php echo $root;?>03patient/prescription.php?status=view" method="post" enctype="multipart/form-data">
	<input type="text" name="patient_id" id="patient_id" placeholder="Patient ID" value=""/>
	<input type="number" name="visit_number" id="visit_number" placeholder="Visit Number" value=""/>
...
<script>
	...
	$('.pd_main_title').html('Search For Existing Patients By Criteria');
...
$(function(){
	...
	$('#pro').on('click','.name_anchor',function(){
		...
		//var mode=$(this).parent().siblings('.mode');
			...
			//console.log($('#patient_id').val()+'&'+$('#visit_number').val());
